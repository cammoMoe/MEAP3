...
\usepackage{float}
%-----------------------------------------------------
\newcommand{\doctitle}{Project 3}
\newcommand{\docsubject}{Medialogy - P3}
\newcommand{\docauthor}{Nicoline Warming Larsen, Aishah Hussain, Camilla Mødekjær \\ Malte Juel Breddam, Morten Porsing, Mathias Ramsø Thomsen}
...
%her burde være et include med introductionen
\include{TabletopRPG}
